...
#define QUICK_HOME                          // If G28 contains XY do a diagonal move first // JKK, custom configuration 
...
#define HOME_AFTER_DEACTIVATE  // Require rehoming after steppers are deactivated // JKK, custom configuration 
 ...
 */
#define G29_RETRY_AND_RECOVER // JKK, custom configuration 
